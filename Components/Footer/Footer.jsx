    ...
    <>
      ...
      <footer className='w-full bg-[#F9F9F9]'>
        <section className='w-full px-[6%] py-7 grid grid-cols-12 gap-y-12 xl:gap-x-16 xl:gap-y-0'>
          ...
          <div className='col-span-12 xl:col-span-4 mt-8 order-5'>
            <div className='w-full flex justify-around xl:justify-between'>
              <div className='flex flex-col'>
                <span className='font-medium text-[18px] md:text-[20px] text-[#505050]'>
          ...
          <div className='col-span-12 flex justify-center mt-8 order-6'>
