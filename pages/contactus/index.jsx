      ...
      <div className='w-full bg-white text-right px-6 md:px-20 py-16 text-gray-800'>
        ...
        <div className='grid lg:grid-cols-3 gap-12'>
          <form
            ...
            className='lg:col-span-2 bg-[#F9F9F9] p-8 rounded-xl shadow space-y-6'
          >
            <h2 className='text-2xl font-bold text-[#CB1B1B] mb-4'>
              ارسال پیام
            </h2>
            <div>
          ...
          <div className='space-y-6'>
            ...
            <div className='bg-gray-100 p-6 rounded-xl shadow text-sm space-y-2'>
              ...
              <a
                href='https://www.instagram.com/iranifarsh'
                target='_blank'
                rel='noopener noreferrer'
