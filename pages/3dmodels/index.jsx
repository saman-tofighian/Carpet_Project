...
const models = [
  { title: 'فرش سه بعدی قدیمی', price: '۱۲,۵۰۰,۰۰۰', path: '/model5.glb' },
...
export default function ThreeDRugsPage() {
  return (
    <section className='w-full px-4 md:px-10 py-10 grid grid-cols-12 gap-y-12 gap-x-6 mt-6 mb-20'>
      ...
      {models.map((model, index) => (
        <div
          key={index}
          className='col-span-12 md:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-2xl'
        >
          <h4 className='text-lg font-semibold mb-4 text-center p-4 flex items-center justify-center'>
            {model.title}
          </h4>
          <div className='aspect-square bg-gray-100 rounded-lg'>
            <Canvas camera={{ position: [2, 3, 10], fov: 30 }}>
              <OrbitControls enablePan={false} makeDefault autoRotate />
              <Suspense fallback={null}>
                <Stage castShadow='city'>
